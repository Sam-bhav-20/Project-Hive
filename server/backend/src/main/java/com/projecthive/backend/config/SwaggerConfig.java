...
public class SwaggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Project Hive : Backend Server",
				"This project is created by project hive","1.0","Terms of Service",
				new Contact("Project Hive","https://projecthive.com","projecthive6@gmail.com"),
